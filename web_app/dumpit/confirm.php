<?php
  ...
  require_once 'includes/config.php';
   if(loggedin()){ 
    ...
    <center><h1 style="color:#3F51B5">All Confirmed requests</h1>
    <?php

    //include 'includes/config.php';
    $provider_id = getuserid();
    $query="SELECT `id`,`user_id`,`start_date`,`end_date`,`pickup_time`,`frequency`, `status` from `request_pickup` WHERE `sp_id` = '$provider_id' AND `is_confirm`='1' AND `status`='0'";
